  ...
  return (
    <>
      <div className="section-header">
        ...
        <p>
          SKU fragmentation, price variance, expiry waste, MDR compliance ·
          All computable from CT-Ecostat / Controlling Dept exports
        </p>
      </div>
      ...
      <div className="alert alert-amber">
        ...
        <div>
          ...
          Consolidation could save 63.2M HUF annually (12% estimate per group - PrimeSourceX, 2025).
        </div>
      </div>
      ...
      <div className="kpi-grid">
        ...
        <div className="kpi-card kpi-amber">
          ...
          <div className="kpi-src">Urgent orders cost 15–30% more (industry avg)</div>
        </div>
        <div className="kpi-card kpi-red">
      ...
      <div className="chart-grid">
        <div className="chart-card">
          ...
          <div className="chart-sub">
            Same product ordered under multiple SKU codes. Est. 12% saving per group through consolidation
          </div>
          <ResponsiveContainer width="100%" height={260}>
            ...
            >
              ...
              />
              <Bar dataKey="total_spend" name="total_spend" fill="rgba(14,165,233,0.3)" radius={[0,4,4,0]} />
              <Bar dataKey="saving"      name="saving"      fill="#0EA5E9"              radius={[0,4,4,0]} />
            </BarChart>
          </ResponsiveContainer>
        </div>
        ...
        <div className="chart-card">
          ...
          <div className="chart-sub">Consumables dominate - highest fragmentation risk</div>
          <ResponsiveContainer width="100%" height={260}>
            <PieChart>
              <Pie
                data={catSpend}
              ...
              >
                {catSpend.map((c, i) => (
                  <Cell key={i} fill={CAT_COLORS[c.name] || '#94A3B8'} />
                ))}
              </Pie>
      ...
      <div className="table-card">
        <div className="table-header">
          <h3>Full SKU List - Price Variance &amp; Compliance</h3>
        ...
        <div style={{ overflowX: 'auto' }}>
          <table className="data-table">
            ...
            <tbody>
              {PROCUREMENT.map((s) => (
                <tr key={s.id} style={{ background: s.variance > 10 ? '#FFFBF0' : 'inherit' }}>
